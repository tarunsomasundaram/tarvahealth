  ...
  return (
    <OnboardingPageWrapper>
      <div className="flex h-full flex-col bg-background">
        ...
        {/* Bottom buttons */}
        <div className="fixed bottom-0 left-0 right-0 z-50 px-6 pb-12 pt-4 bg-gradient-to-t from-background via-background to-transparent" style={{ paddingBottom: 'max(3rem, env(safe-area-inset-bottom))' }}>
          <motion.button
